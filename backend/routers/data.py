...
def _serialize_project(p: Project) -> dict:
    ...
    return {
        ...
        "git_last_commit_at": str(p.git_last_commit_at) if p.git_last_commit_at else None,
        "git_local_last_commit": p.git_local_last_commit,
        "git_local_last_commit_at": str(p.git_local_last_commit_at) if p.git_local_last_commit_at else None,
        "git_remote_last_commit": p.git_remote_last_commit,
        "git_remote_last_commit_at": str(p.git_remote_last_commit_at) if p.git_remote_last_commit_at else None,
        "git_remote_branch": p.git_remote_branch,
        "git_ahead_count": p.git_ahead_count,
        "git_behind_count": p.git_behind_count,
